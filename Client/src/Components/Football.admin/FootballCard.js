...
class TennisCard extends PureComponent {
  ...
  betclick = (event) => {
    const {id} = event.target;
if(id==='3'){
this.setState({fw:3,fullhalf:true})
}
if(id==='4'){
this.setState({fw:4,fullhalf:true})
}
if(id==='5'){
this.setState({fw:5,fullhalf:true})
}
if(id==='6'){
this.setState({g_E_O:6,totalGoal:true})
}
if(id==='7'){
this.setState({g_E_O:7,totalGoal:true})
}
if(id==='8'){
this.setState({Penalty:8,PenaltyMade:true})
}
if(id==='9'){
this.setState({Penalty:9,PenaltyMade:true})
}
if(id==='10'){
this.setState({GoalinNum:10,totalmatchGoal:true})
}
if(id==='11'){
this.setState({GoalinNum:11,totalmatchGoal:true})
}
if(id==='12'){
this.setState({GoalinNum:12,totalmatchGoal:true})
}
if(id==='13'){
this.setState({GoalinNum:13,totalmatchGoal:true})
}
if(id==='14'){
this.setState({GoalinNum:14,totalmatchGoal:true})
}
if(id==='15'){
this.setState({GoalinNum:15,totalmatchGoal:true})
}
  };
  deletetennis=()=>{
